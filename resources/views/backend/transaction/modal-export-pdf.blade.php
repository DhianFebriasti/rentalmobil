<!-- Modal -->
<div class="modal fade" id="exportpdf" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-0">
            <div class="modal-header bg-gradient-warning rounded-0">
            ...
            <div class="modal-body">
                <form action="{{route('transaction.export.pdf')}}" method="POST" enctype="multipart/form-data">
                    @csrf
